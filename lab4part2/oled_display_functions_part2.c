 ...
 * lab4 part 2-read accelerometer values and display the ball movement on the
 * Oled display
 */
...
int main(void){
	...
	begin();
    fillScreen(0xffff);
	initializeAccelPins();//initialize pins for i2c 
    initI2C();//initialize i2c and interrupts and accelerometer
